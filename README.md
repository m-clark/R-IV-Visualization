...
This is the repo for the workshop that focuses on Part IV of  [Data Processing and Visualization](https://m-clark.github.io/data-processing-and-visualization) notes.
...
usethis::use_course(
  'https://github.com/m-clark/R-IV-Visualization/blob/master/workshop_visualization.zip?raw=true', 
  destdir = NULL
)
```
